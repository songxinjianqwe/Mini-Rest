package cn.sinjinsong.sample.controller.mail;

import cn.sinjinsong.sample.domain.dto.mail.MailDTO;
import cn.sinjinsong.sample.domain.dto.mail.MailsUpdatedDTO;
import cn.sinjinsong.sample.domain.entity.mail.MailDO;
import cn.sinjinsong.sample.enumeration.mail.MailStatus;
import cn.sinjinsong.sample.enumeration.mail.QueryMailTarget;
import cn.sinjinsong.sample.enumeration.mail.SendMode;
import cn.sinjinsong.sample.exception.RestValidationException;
import cn.sinjinsong.sample.exception.mail.MailStatusNotFoundException;
import cn.sinjinsong.sample.exception.mail.MailTargetNotFoundException;
import cn.sinjinsong.sample.security.domain.JWTUser;
import cn.sinjinsong.sample.service.mail.MailService;
...
public class MailController {
    ...
    @PreAuthorize("(hasRole('ADMIN') or principal.id == #targetId)")
